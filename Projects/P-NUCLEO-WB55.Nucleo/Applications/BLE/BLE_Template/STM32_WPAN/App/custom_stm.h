...
{
  /* My_GPIO_Char */
  CUSTOM_STM_GPIO_C_READ_EVT,
  CUSTOM_STM_GPIO_C_WRITE_NO_RESP_EVT,
  CUSTOM_STM_GPIO_C_NOTIFY_ENABLED_EVT,
  CUSTOM_STM_GPIO_C_NOTIFY_DISABLED_EVT,
